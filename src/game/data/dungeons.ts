...
export const DUNGEONS: DungeonDefinition[] = [
  ...
  // ── ACT 2 ──────────────────────────────────────────────────────────────────
  {
    ...
    waves: [
      monster("Imp Farmer", 30, 530, [37, 53], 55, 110, 400, [80, 130]),
      monster("Imp Guard", 31, 600, [40, 59], 60, 115, 450, [90, 145]),
      monster("Imp Soldier", 32, 680, [44, 64], 65, 120, 500, [100, 160]),
    ],
    boss: monster("Queen of Imps", 33, 1700, [61, 88], 80, 140, 15000, [1000, 1800],
  ...
  },
  {
    ...
    waves: [
      monster("Magma Snail", 34, 750, [48, 68], 70, 125, 550, [110, 175]),
      monster("Lava Golem", 35, 890, [53, 75], 80, 130, 620, [125, 195]),
      monster("Fire Elemental", 36, 830, [57, 79], 75, 135, 660, [130, 205],
        { name: "Fireball", kind: "burn", power: 1.8, chance: 0.30, cooldown: 3 }),
      monster("Volcanic Boar", 37, 1040, [61, 86], 85, 138, 700, [140, 220]),
    ],
    boss: monster("Emberfire", 38, 2430, [76, 108], 95, 155, 20000, [1400, 2200],
  ...
  },
  {
    ...
    waves: [
      monster("Fire Bat", 39, 980, [59, 84], 72, 140, 720, [145, 225]),
      monster("Cloud of Dense Smoke", 40, 1120, [63, 89], 78, 145, 780, [155, 240],
        { name: "Asphyxiate", kind: "dot", power: 1.6, chance: 0.30, cooldown: 3 }),
      monster("Rock Hound", 41, 1260, [68, 97], 90, 148, 840, [165, 255]),
    ],
    boss: monster("It", 43, 3360, [92, 127], 110, 165, 28000, [1800, 2800],
  ...
  },
  {
    ...
    waves: [
      monster("Lesser Devil", 44, 1420, [74, 103], 95, 155, 900, [180, 275]),
      monster("Obsidian Skeleton", 46, 1570, [82, 112], 105, 160, 980, [195, 300]),
      monster("Hell Wyrm", 47, 1790, [89, 124], 110, 165, 1060, [210, 325]),
      monster("Chaos Warlock", 48, 1650, [86, 118], 100, 168, 1020, [205, 315],
        { name: "Chaos Bolt", kind: "burst", power: 2.1, chance: 0.30, cooldown: 3 }),
    ],
    boss: monster("Reltih", 50, 4680, [112, 155], 130, 185, 38000, [2400, 3600],
  ...
  },
  {
    ...
    waves: [
      monster("Hell Spawn", 51, 2020, [97, 134], 115, 175, 1100, [220, 340]),
      monster("Ghost", 52, 1880, [101, 139], 108, 178, 1080, [215, 335],
        { name: "Soul Drain", kind: "drain", power: 1.6, chance: 0.35, cooldown: 3 }),
      monster("Demon", 54, 2320, [109, 149], 125, 182, 1200, [240, 370]),
    ],
    boss: monster("The Reaper", 57, 6570, [131, 186], 150, 205, 55000, [3200, 5000],
  ...
  },
  {
    ...
    endgame: true,
    waves: [
      monster("The Third Prophet", 60, 3670, [132, 176], 155, 210, 4000, [600, 900],
        { name: "Dark Prophecy", kind: "burst", power: 2.2, chance: 0.35, cooldown: 3 }),
      monster("The Second Prophet", 62, 4260, [143, 191], 162, 218, 4600, [700, 1050],
        { name: "Flame Curse", kind: "burn", power: 2.0, chance: 0.35, cooldown: 3 }),
      monster("The First Prophet", 65, 4800, [155, 207], 170, 225, 5400, [800, 1200],
        { name: "Soul Drain", kind: "drain", power: 1.8, chance: 0.35, cooldown: 3 }),
    ],
    boss: monster("Core of Hell", 70, 18570, [178, 253], 190, 255, 120000, [8000, 14000],
