...
export const UNIQUE_DROP_TABLE: UniqueDropEntry[] = [
  // ── Test drop ─────────────────────────────────────────────────────────────────
  {
    ...
    chance: 0.0025,
    dungeons: ["bandit-town", "bandits-town-hall", ...ACT2_DUNGEONS],
  },
  ...
  {
    generator: generateEyeOfTheStorm,
    chance: 0.0025,
    minLevel: 18,
    maxLevel: 50,
  },
  {
    generator: generateBoneweaveGloves,
    chance: 0.0025,
    minLevel: 20,
    maxLevel: 50,
  },
  {
    generator: generateMaskOfMidnight,
    chance: 0.0025,
    minLevel: 25,
    maxLevel: 55,
  },
  {
    generator: generateMaskOfTwilight,
    chance: 0.0025,
    minLevel: 25,
    maxLevel: 55,
  },
  ...
  {
    generator: generateAegisOfTheFortress,
    chance: 0.003,
    minLevel: 20,
    maxLevel: 55,
    classId: "paladin",
  ...
  {
    generator: generateHeavensWrath,
    chance: 0.002,
    minLevel: 50,
    classId: "paladin",
  },
  {
    generator: generateCrownOfTheFallen,
    chance: 0.0025,
    minLevel: 45,
    maxLevel: 75,
  },
  ...
  // ── Act 1 ─────────────────────────────────────────────────────────────────────
  {
    ...
    chance: 0.015,
    dungeons: ["sewers", "dark-forest"],
  },
  { generator: generateRatKingsCoat, chance: 0.02, dungeons: ["sewers"] },
  {
    generator: generateVenomweaveWrap,
    chance: 0.0025,
    dungeons: ["cave", "foggy-fields", "graveyard"],
    minLevel: 15,
  },
  {
    generator: generateMirrorRing,
    chance: 0.01,
    dungeons: ["bandits-town-hall"],
  },
  ...
  {
    generator: generateReapersHood,
    chance: 0.002,
    dungeons: ACT3_DUNGEONS,
    minLevel: 60,
  },
  { generator: generatePentagram, chance: 0.005, dungeons: ACT2_DUNGEONS },
  {
    generator: generateReapersHood,
    chance: 0.005,
    dungeons: ["the-white-maw"],
  },

  // ── Class weapons ─────────────────────────────────────────────────────────────
  {
    generator: generateJusticar,
    chance: 0.0015,
    classId: "paladin",
    minLevel: 28,
  },
  {
    generator: generateSanctifier,
    chance: 0.0015,
    classId: "paladin",
    minLevel: 50,
  },
  ...
  {
    generator: generateBlooddrinker,
    chance: 0.0015,
    classId: "barbarian",
    minLevel: 10,
    maxLevel: 40,
  ...
  {
    generator: generateWorldbreaker,
    chance: 0.0015,
    classId: "barbarian",
    minLevel: 50,
  },
  ...
  {
    generator: generateApprenticesFocus,
    chance: 0.002,
    classId: "sorceress",
    dungeons: ACT1_DUNGEONS,
  },
  {
    generator: generateTheArcanist,
    chance: 0.001,
    classId: "sorceress",
    dungeons: ["bandits-town-hall", ...ACT2_DUNGEONS.slice(0, 4)],
  },
  {
    generator: generateEternitysEdge,
    chance: 0.001,
    classId: "sorceress",
    dungeons: ACT2_DUNGEONS.slice(3),
  },

  {
    generator: generateShadowfang,
    chance: 0.002,
    classId: "assassin",
    dungeons: ["bandits-town-hall", ...ACT2_DUNGEONS.slice(0, 4)],
  },
  ...
  {
    generator: generateWorldrootTotem,
    chance: 0.003,
    classId: "druid",
    dungeons: ["bandits-town-hall", ...ACT2_DUNGEONS.slice(0, 4)],
    minLevel: 20,
  ...
  {
    generator: generateThornweaveEffigy,
    chance: 0.0015,
    classId: "druid",
    dungeons: ACT3_DUNGEONS.slice(3),
    minLevel: 54,
  },
  {
    generator: generateBloodbriar,
    chance: 0.0015,
    classId: "druid",
    minLevel: 74,
  },
  ...
  {
    generator: generateStormfist,
    chance: 0.002,
    classId: "monk",
    minLevel: 38,
  },
  {
    generator: generateIroncladHauberk,
    chance: 0.0015,
    minLevel: 45,
    maxLevel: 70,
  },
  {
    generator: generateTheGavel,
    chance: 0.002,
    classId: "paladin",
    minLevel: 30,
  },
