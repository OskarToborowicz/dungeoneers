...
export const CLASSES: Record<ClassId, ClassDefinition> = {
  ...
  sorceress: {
    ...
    passive2: {
      name: "Frostfire",
      description: "Every third Frost Bolt calls down a fire comet dealing 125% of Frost Bolt's damage. The comet can critically strike and ignites the enemy for 25% of its damage over 2 turns.",
      short: "Every third Frost Bolt calls down an igniting fire comet.",
      levelRequirement: 20,
    },
    passive3: {
      name: "Time Anomaly",
