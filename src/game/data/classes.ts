...
export const CLASSES: Record<ClassId, ClassDefinition> = {
  ...
  paladin: {
    ...
    ability2: {
      name: "Holy Light",
      description: "Coat yourself in divine radiance and immediately strike the enemy. Your next 3 basic attacks each restore 12% of your maximum life. Charges persist between encounters.",
      short: "Strike immediately and empower your next 3 auto attacks to heal you.",
      manaCost: 50,
      cooldown: 8,
      kind: "holy_light",
      power: 0,
  ...
  druid: {
    id: "druid",
    name: "Druid",
    description: "A guardian of the deep forest who lashes with living vines and shields himself in bark.",
    baseStats: { strength: 10, dexterity: 10, vitality: 10, energy: 10 },
    resourceName: "Mana",
    resourceType: "mana",
    passive: {
      name: "Bramble",
      description: "Basic attacks embed thorns in the enemy. At 3 thorns they erupt, dealing physical damage.",
      short: "Basic attacks stack thorns that erupt at 3 stacks.",
    },
    passive2: {
      name: "Lifebloom",
      description: "Your direct hits heal you for 8% of the damage dealt.",
      short: "Direct hits heal you for part of the damage.",
      levelRequirement: 20,
    },
    passive3: {
      name: "Nature's Wrath",
      description: "Every basic attack afflicts the enemy with a stacking poison.",
      short: "Basic attacks apply stacking poison.",
      levelRequirement: 35,
    },
    ability: {
      name: "Vine Whip",
      description: "A living vine lashes the enemy for weapon damage + Dexterity. 35% chance to leave them bleeding.",
      short: "A Dexterity-powered whip with a chance to cause bleeding.",
      manaCost: 20,
      cooldown: 2,
      kind: "vine_whip",
      power: 1.2,
    ...
    ability2: {
      name: "Grove",
      description: "Summon a protective grove that blocks all of the enemy's attacks for 2 turns.",
      short: "Blocks all incoming damage for 2 turns.",
      manaCost: 45,
      cooldown: 6,
      kind: "bark_wall",
      power: 0,
  ...
  assassin: {
    ...
    ability: {
      name: "Eviscerate",
      description: "Deal 1× weapon damage, plus 0.5× per Preparation spent (up to 2.5×). Spends all Preparation.",
    ...
    ability2: {
      name: "Vanish",
      description: "Hurl a burst of metal powder for 0.75× weapon damage, then reduce all incoming damage by 55% for 1 turn (+1 per Preparation spent). Clears all negative effects. Spends all Preparation.",
      short: "A strike followed by a shroud that greatly reduces incoming damage, scaling with Preparation.",
      manaCost: 0,
      cooldown: 8,
      kind: "vanish",
      power: 0.75,
