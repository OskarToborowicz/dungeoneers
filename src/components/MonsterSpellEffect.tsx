...
function FireWallFx() {
  return (
    <g>
      ...
      <g
        className="mse-fire-pillar mse-fp-1"
        style={{ transformOrigin: "70px 110px" }}
      >
        <polygon
          points="70,110 63,72 67,52 70,40 73,52 77,72"
          fill="#ff4400"
          opacity="0.92"
        />
        <polygon
          points="70,110 65,80 70,62 75,80"
          fill="#ff8800"
          opacity="0.85"
        />
        <polygon
          points="70,110 67,88 70,76 73,88"
          fill="#ffcc00"
          opacity="0.8"
        />
      </g>
      <g
        className="mse-fire-pillar mse-fp-2"
        style={{ transformOrigin: "100px 110px" }}
      >
        <polygon
          points="100,110 92,68 97,46 100,34 103,46 108,68"
          fill="#ff4400"
          opacity="0.92"
        />
        <polygon
          points="100,110 95,78 100,58 105,78"
          fill="#ff8800"
          opacity="0.85"
        />
        <polygon
          points="100,110 97,86 100,74 103,86"
          fill="#ffcc00"
          opacity="0.8"
        />
      </g>
      <g
        className="mse-fire-pillar mse-fp-3"
        style={{ transformOrigin: "130px 110px" }}
      >
        <polygon
          points="130,110 123,72 127,52 130,40 133,52 137,72"
          fill="#ff4400"
          opacity="0.92"
        />
        <polygon
          points="130,110 125,80 130,62 135,80"
          fill="#ff8800"
          opacity="0.85"
        />
        <polygon
          points="130,110 127,88 130,76 133,88"
          fill="#ffcc00"
          opacity="0.8"
        />
      </g>
...
function BloodDrainFx() {
  return (
    <g className="mse-drain">
      ...
      <path
        d="M35,45 C70,20 120,30 165,50"
        fill="none"
        stroke="#cc0022"
        strokeWidth="3"
        strokeLinecap="round"
        className="mse-drain-stream mse-ds-1"
        strokeDasharray="140"
        strokeDashoffset="140"
      />
      <path
        d="M35,60 C70,55 120,55 165,60"
        fill="none"
        stroke="#aa0018"
        strokeWidth="2.5"
        strokeLinecap="round"
        className="mse-drain-stream mse-ds-2"
        strokeDasharray="130"
        strokeDashoffset="130"
      />
      <path
        d="M35,75 C70,90 120,80 165,68"
        fill="none"
        stroke="#cc0022"
        strokeWidth="2.5"
        strokeLinecap="round"
        className="mse-drain-stream mse-ds-3"
        strokeDasharray="140"
        strokeDashoffset="140"
      />
